...
\end{equation}
This expression is valid for generic values of $s$ and $t$. However, in the \textbf{Regge limit},
\begin{equation}
...
Diagrammatically, the Regge limit turns the square polygon in (\ref{BoxDiagram}) into a digon made of matter lines, multiplied by a certain overall factor:
\begin{equation}
	\vcenter{\hbox{\includegraphics[scale=0.4]{figures/box.pdf}}} \quad \longrightarrow \quad (\cdots)\vcenter{\hbox{\includegraphics[scale=0.4]{figures/regge_box.pdf}}}
	\label{ReggeBox}
\end{equation}
